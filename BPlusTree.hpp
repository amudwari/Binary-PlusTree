...
public:
    ...
    using EntryType = std::tuple<KeyType, std::string, LeafNode*>;

    /// Returns true if this B+ tree has no keys or values.
    bool isEmpty() const;

    /// Insert a key-value pair into this B+ tree.
    void insert(KeyType aKey, std::string aValue);
...
private:
    void startNewTree(KeyType aKey, std::string aValue);
    void insertIntoLeaf(KeyType aKey, std::string aValue);
